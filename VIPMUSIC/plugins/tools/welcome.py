...
def welcomepic(pic, user, chat, id, uname):
    ...
    draw.text((610, 517), f'NAME : {unidecode(user)}', fill="white", font=font)
    draw.text((650, 547), f'ID : {id}', fill="white", font=font)
    draw.text((700, 580), f"USERNAME : {uname}", fill="white",font=font)
