...
def welcomepic(pic, user, chat, id, uname):
    ...
    draw.text((610, 900), f'NAME : {unidecode(user)}', fill="white", font=font)
    draw.text((650, 800), f'ID : {id}', fill="white", font=font)
    draw.text((700, 700), f"USERNAME : {uname}", fill="white",font=font)
